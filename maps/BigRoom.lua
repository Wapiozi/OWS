...
function loadMap(transitionInd)
    ...
    --[[1]] graph1:addVertex(0.6, 2.9, {q = 1,[1] = {vertex = 2}})
    --[[2]] graph1:addVertex(1.9, 2.9, {q = 3,[1] = {vertex = 1}, [2] = {vertex = 4}, [3] = {vertex = 3}})
    --[[3]] graph1:addVertex(4.1, 2.9, {q = 2,[1] = {vertex = 2}, [2] = {vertex = 6} })
    --[[4]] graph1:addVertex(1.9, 2.7, {q = 2,[1] = {vertex = 2}, [2] = {vertex = 5} })
    --[[5]] graph1:addVertex(3.1, 2.7, {q = 3,[1] = {vertex = 4}, [2] = {vertex = 6}, [3] ={vertex = 7} })
    --[[6]] graph1:addVertex(4.1, 2.7, {q = 2,[1] = {vertex = 3}, [2] = {vertex = 5}})
    --[[7]] graph1:addVertex(3.1, 2.5, {q = 2,[1] = {vertex = 5}, [2] = {vertex = 8}})
