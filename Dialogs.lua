...
function Dialogs:startConversation(enemy1)
    ...
    if enemy1.type.name == "NpcTypeChallenge" then
        if enemy1.question == true then
            ...
            love.graphics.draw(MessageFromNpcImg, 0, 0, 0, MessageFromNpc.scale, MessageFromNpc.scale)
            --for enemy1
            ...
            if strNum == 1 then
                love.graphics.printf(Dialogs:readStr(strNum,NpcTypeChallengeQuestions).f, relateWH(0.275), relateWH(0.75) ,relateWH(1),left,0,relateWH(0.002))
            ...
            x1 = x1 - camera._x
            y1 = y1 - camera._y
            suit.Label(Dialogs:readStr(randForPhrase,NpcTypeChallengeCommonPhrases).f, x1-relateWH(0.05), y1-relateWH(0.1), relateWH(0.1), relateWH(0.1))
            suit.Button("talk", x1+relateWH(0.05), y1, relateWH(0.05), relateWH(0.025))
